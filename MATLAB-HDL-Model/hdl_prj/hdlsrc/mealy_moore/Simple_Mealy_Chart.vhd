...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ready_reg <= '1';
      count_en_reg <= '0';
      --Entry: Meanly-Moore/mealy_sf/Simple_Mealy_Chart
      --Entry Internal: Meanly-Moore/mealy_sf/Simple_Mealy_Chart
      --Transition: '<S5>:12'
  ...
  BEGIN
    ...
    --Gateway: Meanly-Moore/mealy_sf/Simple_Mealy_Chart
    --During: Meanly-Moore/mealy_sf/Simple_Mealy_Chart
    CASE is_Simple_Mealy_Chart IS
      WHEN IN_COUNTING =>
        --During 'COUNTING': '<S5>:7'
