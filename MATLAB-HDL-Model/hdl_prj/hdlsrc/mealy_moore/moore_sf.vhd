...
ARCHITECTURE rtl OF moore_sf IS
  ...
  COMPONENT FrequencyGeneratorSystem
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          FreqIn                          :   IN    std_logic;
  ...
  FOR ALL : FrequencyGeneratorSystem
    USE ENTITY work.FrequencyGeneratorSystem(rtl);

  -- Signals
  SIGNAL HDL_Counter_out1                 : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL count_en                         : std_logic;
  SIGNAL HDL_Counter_stepreg              : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL FrequencyGeneratorSystem_out1    : std_logic;

BEGIN
  -- <S6>/Simple_Moore_Chart
  ...
  -- <S6>/FrequencyGeneratorSystem
  u_FrequencyGeneratorSystem : FrequencyGeneratorSystem
    PORT MAP( clk => clk,
              reset => reset,
              FreqIn => get_going,
              FreqOut => FrequencyGeneratorSystem_out1
              );
  ...
  FrequencyGenerator <= FrequencyGeneratorSystem_out1;
