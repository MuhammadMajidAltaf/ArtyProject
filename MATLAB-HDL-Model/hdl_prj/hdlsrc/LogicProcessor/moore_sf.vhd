-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\LogicProcessor\moore_sf.vhd
...
-- 
-- Module: moore_sf
-- Source Path: LogicProcessor/LogicProcessor/moore_sf
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF count_en = '1' THEN 
        IF HDL_Counter_out1 = to_unsigned(16#31#, 8) THEN 
          HDL_Counter_stepreg <= to_unsigned(16#CE#, 8);
        ELSE 
          HDL_Counter_stepreg <= to_unsigned(16#01#, 8);
        END IF;
      END IF;
