-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\LogicProcessor\mealy_sf1.vhd
...
-- 
-- Module: mealy_sf1
-- Source Path: LogicProcessor/LogicPRocessor/mealy_sf1
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF mealy_sf1 IS
  ...
  SIGNAL Simple_Mealy_Chart_out2          : std_logic;
...
BEGIN
  u_Simple_Mealy_Chart : Simple_Mealy_Chart
    PORT MAP( clk => clk,
              ...
              ready => ready,
              count_en => Simple_Mealy_Chart_out2
              );
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF Simple_Mealy_Chart_out2 = '1' THEN 
  ...
  enable <= Simple_Mealy_Chart_out2;
