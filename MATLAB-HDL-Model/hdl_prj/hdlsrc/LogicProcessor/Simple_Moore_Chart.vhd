-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\LogicProcessor\Simple_Moore_Chart.vhd
...
-- Source Path: LogicProcessor/LogicProcessor/moore_sf/Simple_Moore_Chart
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Simple_Moore_Chart IS
  ...
  SIGNAL CH1_FREQ1_INPUT1_unsigned        : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL is_Simple_Moore_Chart            : T_state_type_is_Simple_Moore_Chart;  -- uint8

BEGIN
  count_unsigned <= unsigned(count);

  CH1_FREQ1_INPUT1_unsigned <= unsigned(CH1_FREQ1_INPUT1);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      ...
      CASE is_Simple_Moore_Chart IS
        WHEN IN_COUNTING =>
          IF resize(count_unsigned, 32) = CH1_FREQ1_INPUT1_unsigned THEN 
