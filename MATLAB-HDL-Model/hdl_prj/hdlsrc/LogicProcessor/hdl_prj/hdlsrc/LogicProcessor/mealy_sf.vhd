-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\LogicProcessor\mealy_sf.vhd
...
-- 
-- Module: mealy_sf
-- Source Path: LogicProcessor/LogicProcessor/mealy_sf
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  u_Simple_Mealy_Chart : Simple_Mealy_Chart
    PORT MAP( clk => clk,
              reset => reset,
              get_going => CH2_SIG_INPUT,
              count => std_logic_vector(HDL_Counter_out1),  -- uint8
              CH2_FREQ_INPUT1 => CH2_FREQ_INPUT1,  -- uint32
              ready => ready,
              count_en => count_en
              );
